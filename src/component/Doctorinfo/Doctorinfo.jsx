...
import img from "./../../assets/Field/Doctors/Mask group-1.png";
import Ellipse1 from "./../../assets/Doctor Info/Ellipse.png";
import Ellipse2 from "./../../assets/Doctor Info/Ellipse-1.png";
import Ellipse3 from "./../../assets/Doctor Info/Ellipse-2.png";
import Ellipse4 from "./../../assets/Doctor Info/Ellipse-3.png";
import Ellipse5 from "./../../assets/Doctor Info/Ellipse-4.png";
import Ellipse6 from "./../../assets/Doctor Info/Ellipse-5.png";
...
export default function Doctorinfo() {
  ...
  return (
    <>
      <Helmet>
        <title>Doctor Info - Unity Hospital</title>
      </Helmet>
      <section className=" 2xl:container mx-auto">
            ...
            <div className="md:w-2/3  md:bg-background-gradient p-6 text-white">
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc list-inside mt-2 text-xs">
                  ...
                  <li className="font-semibold">
                    American Board of Internal Medicine (ABIM) – Internal
                    Medicine
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc list-inside mt-2 text-xs">
                  ...
                  <li className="font-semibold">
                    Excellence in Cardiac Care, American Heart Association
                    (2020)
                  </li>
                </ul>
              </div>
        ...
        <section className="lg:w-[80%] w-[90%] mx-auto my-20">
          <div>
            <h1 className="font-semibold mb-9  text-c2 text-2xl">
              Top Rating:
            </h1>
          </div>
          <div className="grid md:grid-cols-3 gap-y-9 gap-x-8">
            <div>
              ...
              <article className="text-sm w-[90%] mt-3">
                ...
                improved my health. Thank you for your dedication and
                compassion.
              </article>
            </div>
            <div>
