              ...
              <div className="flex gap-5 items-center align-middle">
                ...
                <div className="mt-11 w-[80%]  mx-auto">
                  ...
                  <article className="text-cgray font-light text-xl xl:max-w-[66%] md:w-[80%] lg:w-[70%] w-72 mt-7 mb-7">
                    we unite advanced medical expertise with compassionate care
                    to ensure the health and well-being of our community.
                  </article>
        ...
        <section className=" bg-[url('assets/HomePage/Our%20Services/Group%2058.png')] bg-opacity-0 bg-center bg-cover md:mt-11 relative xl:pb-52 lg:pb-52 pb-9 m">
          ...
          <div className="grid gap-x-5 gap-y-14 grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 w-[80%] mx-auto mt-20">
            ...
            <div className="text-center">
              ...
              <p className="text-white xl:text-base lg:text-base md:text-base sm:text-sm text-[11px] font-thin md:w-[80%] mx-auto">
                Offering a wide range of surgical procedures, including
                minimally invasive and robotic surgeries, performed by skilled
                surgeons.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-white xl:text-base lg:text-base md:text-base sm:text-sm text-[11px] font-thin md:w-[80%] mx-auto">
                Comprehensive care throughout pregnancy, childbirth, and
                postnatal periods, with advanced NICUs for newborns.
              </p>
            </div>
            <div className="text-center">
              <img
