...
const Doctors = () => {
  ...
  const doctors = [
    { img: img, name: "Dr. Morgan Schmidt", specialty: "Cardiology", rating: "4.9/5" },
    { img: img1, name: "Dr. David Garcia", specialty: "Psychiatry", rating: "4.7/5" },
    { img: img2, name: "Dr. Michael Lee", specialty: "Orthopedics", rating: "4.8/5" },
    { img: img3, name: "Dr. Emily Wang", specialty: "Neurology", rating: "4.8/5" },
  ];
      ...
      <div className="w-[90%] mx-auto p-6">
        <div className="relative mb-6">
          ...
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
            <button onClick={handleSearch} className="p-2 flex items-center justify-center">
              <FaSearch />
            </button>
          </div>
        </div>
        ...
        <section>
          {searchQuery ? (
            <>
              <h2 className="text-2xl text-[#1E8ACB] font-semibold mb-4">Search Results</h2>
            ...
            <>
              <h2 className="text-2xl text-[#1E8ACB] font-semibold mb-4">Top Rated Doctors</h2>
              <Slider {...settings}>
              ...
              <section className="my-8">
                <h2 className="text-2xl text-[#1E8ACB] font-semibold mb-4">Today's Available Doctors</h2>
                <Slider {...settings}>
                  {doctors.map((doctor, index) => (
                    <DoctorCard key={index} doctor={doctor} />
                  ))}
              ...
              {/* All Doctors Section */}
              <section>
                <h2 className="text-2xl text-[#1E8ACB] font-semibold mb-4">All Doctors</h2>
                <Slider {...settings}>
                  {doctors.map((doctor, index) => (
                    <DoctorCard key={index} doctor={doctor} />
                  ))}
